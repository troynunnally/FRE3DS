...
void ModelGL::render()
{
   ...
   /* Misc stuff */
	 ...
	 if (stereo) {
	  ...
	  glDrawArrays(GL_LINES, 0, 250);			//Draw the line starting from index 0 with 12 elements
	...
	//Render Vertes Buffer Object (VBO) for non-stereo mode 
	 ...
	 glDrawArrays(GL_LINES, 0, 50);			//Draw the line starting from index 0 with 12 elements
