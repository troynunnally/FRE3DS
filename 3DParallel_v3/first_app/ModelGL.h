...
private:
	...
	GLuint m_vertexBuffer[2];				//Vertex Buffer ID used to store the names of the buffer
	GLuint m_numVertexBufElements;		//

	GLuint m_vertexBuffer2[2];				//Vertex Buffer ID used to store the names of the buffer
	GLuint m_numVertexBufElements2;		//


	int leftplane;						//Number of left planes
	int avgYtotalZ;
};
